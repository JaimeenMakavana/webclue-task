...
const FooterContent = () => {
  return (
    ...
    <div className="flex flex-col justify-center items-center gap-3 py-32 relative ">
      ...
      <h2 className="sora text-center text-[40px] md:text-[50px]  max-w-3xl relative">
        Be part of the future of <span className="relative">IdentityHub<Image src={UnderlineImg} alt="" width={100} height={30} className="absolute inset-x-0 -bottom-2 w-[79%]" />
        </span>
      </h2>
