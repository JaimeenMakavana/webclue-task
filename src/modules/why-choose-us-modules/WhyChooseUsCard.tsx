...
const WhyChooseUsCard = ({ choose }: { choose: ChooseType }) => {
  return (
    <div className="grid lg:grid-cols-2 gap-5 border border-[#1f1e1e] rounded-lg p-3 md:p-5 lg:p-6 max-w-4xl">
      <div className="text-[#CAD1E9] relative">
        ...
        <div className="flex justify-start items-center gap-2">
          <div className="rounded-full p-1 w-fit" style={{ background: choose.color }}>
